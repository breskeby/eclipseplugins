...
import com.breskeby.eclipse.gradle.launch.GradleLaunchConfigurationMessages;
...
public class VariableInputDialog extends Dialog {
	...
	protected Control createDialogArea(Composite parent) {
		...
		label.setText(GradleLaunchConfigurationMessages.AddVariableStringAction_2);
		...
		button.setText(GradleLaunchConfigurationMessages.AddVariableStringAction_3);		
	...
	protected void configureShell(Shell newShell) {
		...
		newShell.setText(GradleLaunchConfigurationMessages.AddVariableStringAction_4);
	}
