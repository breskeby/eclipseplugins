...
public interface IAntUIConstants {
	 ...
	 */
	public static final String PLUGIN_ID = "com.breskeby.eclipse.gradle"; //$NON-NLS-1$;
	...
	public static final String DIALOGSTORE_LASTGRADLEHOME= PLUGIN_ID + ".lastgradlehome"; //$NON-NLS-1$
